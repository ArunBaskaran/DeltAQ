...
SELECT
  "time" AS "time",
  value, (select avg(value) from usa b where b.zip = 85006 and b.parameter = 'pm10' and b.week = date_part('week', a.time) and date_part('year', b.time) = 2019) as weekly_avg
FROM usa a
WHERE
